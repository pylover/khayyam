...
class JalaliDateFormatterTestCase(unittest.TestCase):
    ...
    def test_year(self):
        ...
        self.assertEqual(JalaliDate.strptime('۹۴', '%n'), JalaliDate(1394))
        self.assertEqual(JalaliDate.strptime('۱', '%n'), JalaliDate(1301))
        self.assertEqual(JalaliDate.strptime('۰', '%n'), JalaliDate(1300))
        self.assertEqual(JalaliDate.strptime('۹۴', '%u'), JalaliDate(1394))
        self.assertEqual(JalaliDate.strptime('۰۱', '%u'), JalaliDate(1301))
        self.assertEqual(JalaliDate.strptime('۰۰', '%u'), JalaliDate(1300))
